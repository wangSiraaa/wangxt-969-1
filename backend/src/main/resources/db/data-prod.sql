...
-- ============================================
INSERT INTO nursing_level (id, code, name, description, min_score, max_score, base_hourly_rate, risk_level, required_qualifications, enabled, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET code=EXCLUDED.code, name=EXCLUDED.name, description=EXCLUDED.description, min_score=EXCLUDED.min_score, max_score=EXCLUDED.max_score, base_hourly_rate=EXCLUDED.base_hourly_rate, risk_level=EXCLUDED.risk_level, required_qualifications=EXCLUDED.required_qualifications, enabled=EXCLUDED.enabled, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 2. 服务包 (service_package)
-- ============================================
INSERT INTO service_package (id, code, name, description, service_type, standard_duration_minutes, base_price, hourly_rate, minimum_nursing_level_code, required_qualifications, risk_level, insurable, insurance_code, enabled, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET code=EXCLUDED.code, name=EXCLUDED.name, description=EXCLUDED.description, service_type=EXCLUDED.service_type, standard_duration_minutes=EXCLUDED.standard_duration_minutes, base_price=EXCLUDED.base_price, hourly_rate=EXCLUDED.hourly_rate, minimum_nursing_level_code=EXCLUDED.minimum_nursing_level_code, required_qualifications=EXCLUDED.required_qualifications, risk_level=EXCLUDED.risk_level, insurable=EXCLUDED.insurable, insurance_code=EXCLUDED.insurance_code, enabled=EXCLUDED.enabled, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 3. 禁忌事项 (contraindication)
-- ============================================
INSERT INTO contraindication (id, code, name, category, severity, description, handling_notes, excluded_qualifications, enabled, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET code=EXCLUDED.code, name=EXCLUDED.name, category=EXCLUDED.category, severity=EXCLUDED.severity, description=EXCLUDED.description, handling_notes=EXCLUDED.handling_notes, excluded_qualifications=EXCLUDED.excluded_qualifications, enabled=EXCLUDED.enabled, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 4. 老人档案 (elder)
-- ============================================
INSERT INTO elder (id, elder_code, name, id_card, gender, birth_date, phone, address, longitude, latitude, service_area, nursing_level_id, service_package_id, health_status, allergies, contraindication_ids, emergency_contacts, insurant_no, insurance_type, insurance_coverage, status, pause_start_time, pause_end_time, pause_reason, risk_level, credit_score, avatar_url, remark, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET elder_code=EXCLUDED.elder_code, name=EXCLUDED.name, id_card=EXCLUDED.id_card, gender=EXCLUDED.gender, birth_date=EXCLUDED.birth_date, phone=EXCLUDED.phone, address=EXCLUDED.address, longitude=EXCLUDED.longitude, latitude=EXCLUDED.latitude, service_area=EXCLUDED.service_area, nursing_level_id=EXCLUDED.nursing_level_id, service_package_id=EXCLUDED.service_package_id, health_status=EXCLUDED.health_status, allergies=EXCLUDED.allergies, contraindication_ids=EXCLUDED.contraindication_ids, emergency_contacts=EXCLUDED.emergency_contacts, insurant_no=EXCLUDED.insurant_no, insurance_type=EXCLUDED.insurance_type, insurance_coverage=EXCLUDED.insurance_coverage, status=EXCLUDED.status, pause_start_time=EXCLUDED.pause_start_time, pause_end_time=EXCLUDED.pause_end_time, pause_reason=EXCLUDED.pause_reason, risk_level=EXCLUDED.risk_level, credit_score=EXCLUDED.credit_score, avatar_url=EXCLUDED.avatar_url, remark=EXCLUDED.remark, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 5. 紧急联系人 (emergency_contact)
-- ============================================
INSERT INTO emergency_contact (id, elder_id, name, relation, phone, alt_phone, address, is_primary, can_confirm_service, notify_on_abnormal, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET elder_id=EXCLUDED.elder_id, name=EXCLUDED.name, relation=EXCLUDED.relation, phone=EXCLUDED.phone, alt_phone=EXCLUDED.alt_phone, address=EXCLUDED.address, is_primary=EXCLUDED.is_primary, can_confirm_service=EXCLUDED.can_confirm_service, notify_on_abnormal=EXCLUDED.notify_on_abnormal, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 6. 护理员档案 (nurse)
-- ============================================
INSERT INTO nurse (id, nurse_code, name, id_card, gender, birth_date, phone, address, longitude, latitude, service_areas, max_daily_orders, max_weekly_hours, max_continuous_hours, travel_time_radius_minutes, highest_nursing_level_id, qualification_summary, average_rating, completed_orders_count, on_time_rate, status, hire_date, avatar_url, remark, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET nurse_code=EXCLUDED.nurse_code, name=EXCLUDED.name, id_card=EXCLUDED.id_card, gender=EXCLUDED.gender, birth_date=EXCLUDED.birth_date, phone=EXCLUDED.phone, address=EXCLUDED.address, longitude=EXCLUDED.longitude, latitude=EXCLUDED.latitude, service_areas=EXCLUDED.service_areas, max_daily_orders=EXCLUDED.max_daily_orders, max_weekly_hours=EXCLUDED.max_weekly_hours, max_continuous_hours=EXCLUDED.max_continuous_hours, travel_time_radius_minutes=EXCLUDED.travel_time_radius_minutes, highest_nursing_level_id=EXCLUDED.highest_nursing_level_id, qualification_summary=EXCLUDED.qualification_summary, average_rating=EXCLUDED.average_rating, completed_orders_count=EXCLUDED.completed_orders_count, on_time_rate=EXCLUDED.on_time_rate, status=EXCLUDED.status, hire_date=EXCLUDED.hire_date, avatar_url=EXCLUDED.avatar_url, remark=EXCLUDED.remark, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;

-- ============================================
-- 7. 护理员资质 (nurse_qualification)
-- ============================================
INSERT INTO nurse_qualification (id, nurse_id, type, name, certificate_no, issued_date, expiry_date, issuing_authority, level, service_type_scope, nursing_level_scope, certificate_url, status, verified, verified_by, created_at, updated_at, deleted) VALUES
...
ON CONFLICT (id) DO UPDATE SET nurse_id=EXCLUDED.nurse_id, type=EXCLUDED.type, name=EXCLUDED.name, certificate_no=EXCLUDED.certificate_no, issued_date=EXCLUDED.issued_date, expiry_date=EXCLUDED.expiry_date, issuing_authority=EXCLUDED.issuing_authority, level=EXCLUDED.level, service_type_scope=EXCLUDED.service_type_scope, nursing_level_scope=EXCLUDED.nursing_level_scope, certificate_url=EXCLUDED.certificate_url, status=EXCLUDED.status, verified=EXCLUDED.verified, verified_by=EXCLUDED.verified_by, created_at=EXCLUDED.created_at, updated_at=EXCLUDED.updated_at, deleted=EXCLUDED.deleted;
